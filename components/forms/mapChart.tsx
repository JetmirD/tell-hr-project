...
const MapChart: React.FC = () => {
  useEffect(() => {
    ...
    try {
      ...
      // Add data
      const data = [
        { title: "United States", latitude: 39.563353, longitude: -99.316406, value: 12 },
        { title: "PRISHTINA", latitude: 35.3275, longitude: 10.8189, value: 5 },
        { title: "TIRANA", latitude: 42.6629, longitude: 25.1655, value: 5 },
      ];
